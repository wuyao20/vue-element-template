<template>
  <div class="app-container">
    <div class="filter-container">
      <label class="filter-item">权限名称：</label>
      <el-input v-model="listQuery.roleName" placeholder="权限名称" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
      <el-button v-waves class="filter-item" type="primary" icon="el-icon-search" @click="handleFilter">查询</el-button>
      <el-button v-waves class="filter-item" type="primary" icon="el-icon-edit-outline" @click="createRole">新建权限</el-button>
      <el-table
        :key="tableKey"
...
export default {
  ...
  data() {
    return {
      ...
      temp: {},
      rules: {
        roleName: [{ required: true, message: '权限名称必填' }]
      },
      departments: []
    }
  },
